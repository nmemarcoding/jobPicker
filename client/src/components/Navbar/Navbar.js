    ...
    <div className="navbar bg-base-100">
      ...
      <form className="hidden md:block" >
        <div className="flex items-center">
          <input type="text" className="p-2 flex-grow " onChange={(e)=> setSearchData(e.target.value)}/>
          <button className="btn btn-ghost btn-circle" onClick={() =>  navigate(`/search/${searchData}`) }>

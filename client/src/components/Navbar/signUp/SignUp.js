...
export default function SignUp() {
    ...
    const  handleLogin =  (e)=>{
        e.preventDefault();
        publicRequest.post('auth/register',{username,password,email}).then((res)=>{
    ...
    return (
        ...
        <div className='flex justify-center items-center h-full'>
            <form className='max-w-[400px] w-full mx-auto bg-white p-8'>
                ...
                <button className='w-full py-3 mt-8 bg-indigo-600 hover:bg-indigo-500 relative text-white'onClick={handleLogin}>Sign Up</button>
